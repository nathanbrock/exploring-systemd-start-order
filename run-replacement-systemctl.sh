...
clean_up() {
    ...
    screencapture $SCENARIO_PATH/results/exit-$SERVICE_A_EXIT_CODE-replacement-systemctl-output.png
    ...
    screencapture $SCENARIO_PATH/results/exit-$SERVICE_A_EXIT_CODE-replacement-systemctl-status.png
